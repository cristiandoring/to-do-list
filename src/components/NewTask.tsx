const NewTask = () => {
  return (
    <form className="w-full flex items-center gap-4 justify-center mb-4">
      <label>
        <input type="text" placeholder="Add your new task" className="border-2 border-neutral-400 rounded-md w-110 px-4 py-2 text-black h-12 outline-neutral-500 text-[20px] hover:cursor-pointer"/>
      </label>
